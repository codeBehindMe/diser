...
var SuperClusterAlgorithm = class extends AbstractAlgorithm {
  ...
  calculate(input) {
    ...
    const state2 = { zoom: input.map.getZoom() };
    if (!changed) {
      if (this.state.zoom > this.maxZoom && state2.zoom > this.maxZoom)
        ;
      else {
        changed = changed || !(0, import_fast_equals.deepEqual)(this.state, state2);
      }
    }
    this.state = state2;
    if (changed) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TransitionComponent, _extends({
    ...
    children: (state2, childProps) => {
      return /* @__PURE__ */ React16.cloneElement(children, _extends({
        ...
        }, styles[state2], style3, children.props.style),
        ref: handleRef
      }, childProps));
    }
  }));
...
var useUtilityClasses4 = (ownerState) => {
  ...
  const slots = {
    ...
    modal: ["modal"],
    paper: ["paper", `paperAnchor${capitalize_default(anchor2)}`, variant !== "temporary" && `paperAnchorDocked${capitalize_default(anchor2)}`]
  };
...
function isHorizontal(anchor2) {
  return ["left", "right"].indexOf(anchor2) !== -1;
}
function getAnchor(theme, anchor2) {
  return theme.direction === "rtl" && isHorizontal(anchor2) ? oppositeDirection[anchor2] : anchor2;
}
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-CDVJTZIJ.js.map
