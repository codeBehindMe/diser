import {
  MapContext
} from "/build/_shared/chunk-VIZ6JHA2.js";
import "/build/_shared/chunk-6YCRFQN3.js";
import {
  ButtonBase_default,
  Button_default,
  HTMLElementType,
  ...
  useTheme,
  useThemeProps
} from "/build/_shared/chunk-XGLI3GBK.js";
import {
  require_react_dom
} from "/build/_shared/chunk-LYBWQ6RX.js";
import {
  React,
  __commonJS,
  __esm,
...
var require_index_umd = __commonJS({
  "node_modules/@googlemaps/react-wrapper/dist/index.umd.js"(exports, module) {
    ...
    (function(global2, factory) {
    ...
    })(exports, function(exports2, jsApiLoader, React40) {
      "use strict";
      function _interopDefaultLegacy(e) {
        return e && typeof e === "object" && "default" in e ? e : { "default": e };
      }
      var React__default = /* @__PURE__ */ _interopDefaultLegacy(React40);
      ...
      const Wrapper2 = ({ children, render, callback, ...options }) => {
        const [status, setStatus] = React40.useState(exports2.Status.LOADING);
        React40.useEffect(() => {
  ...
  "node_modules/fast-equals/dist/fast-equals.js"(exports, module) {
    ...
    (function(global2, factory) {
      ...
      function createComparator(createIsEqual) {
        var isEqual = typeof createIsEqual === "function" ? createIsEqual(comparator) : function(a2, b, indexOrKeyA, indexOrKeyB, parentA, parentB, meta) {
...
// node_modules/react-smooth/node_modules/fast-equals/dist/fast-equals.js
var require_fast_equals2 = __commonJS({
  "node_modules/react-smooth/node_modules/fast-equals/dist/fast-equals.js"(exports, module) {
    init_react();
    (function(global2, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2["fast-equals"] = {}));
    })(exports, function(exports2) {
...
var require_Transition = __commonJS({
  "node_modules/react-smooth/node_modules/react-transition-group/Transition.js"(exports) {
    ...
    var PropTypes13 = _interopRequireWildcard(require_prop_types());
    ...
    var Transition2 = /* @__PURE__ */ function(_React$Component) {
      ...
      _proto.render = function render() {
        ...
        var _this$props = this.props, children = _this$props.children, childProps = _objectWithoutPropertiesLoose15(_this$props, ["children"]);
    ...
    Transition2.contextTypes = {
      transitionGroup: PropTypes13.object
    };
    ...
    Transition2.propTypes = true ? {
      children: PropTypes13.oneOfType([PropTypes13.func.isRequired, PropTypes13.element.isRequired]).isRequired,
      in: PropTypes13.bool,
      mountOnEnter: PropTypes13.bool,
      unmountOnExit: PropTypes13.bool,
      appear: PropTypes13.bool,
      enter: PropTypes13.bool,
      exit: PropTypes13.bool,
...
var require_TransitionGroup = __commonJS({
  "node_modules/react-smooth/node_modules/react-transition-group/TransitionGroup.js"(exports, module) {
    ...
    var TransitionGroup2 = /* @__PURE__ */ function(_React$Component) {
      ...
      _proto.render = function render() {
        var _this$props = this.props, Component5 = _this$props.component, childFactory = _this$props.childFactory, props = _objectWithoutPropertiesLoose15(_this$props, ["component", "childFactory"]);
...
var require_ReplaceTransition = __commonJS({
  "node_modules/react-smooth/node_modules/react-transition-group/ReplaceTransition.js"(exports, module) {
    ...
    var ReplaceTransition = /* @__PURE__ */ function(_React$Component) {
      ...
      _proto.render = function render() {
        var _this$props = this.props, children = _this$props.children, inProp = _this$props.in, props = _objectWithoutPropertiesLoose15(_this$props, ["children", "in"]);
...
var Slide = /* @__PURE__ */ React2.forwardRef(function Slide2(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return /* @__PURE__ */ React2.cloneElement(children, _extends({
        ref: handleRef,
        style: _extends({
...
var KDBush = class {
  constructor(points, getX4 = defaultGetX, getY4 = defaultGetY, nodeSize = 64, ArrayType = Float64Array) {
    ...
    for (let i = 0; i < points.length; i++) {
      ids[i] = i;
      coords[2 * i] = getX4(points[i]);
      coords[2 * i + 1] = getY4(points[i]);
    }
  ...
  within(x2, y2, r) {
    return within(this.ids, this.coords, x2, y2, r, this.nodeSize);
  }
};
...
var Supercluster = class {
  ...
  load(points) {
    const { log: log2, minZoom, maxZoom, nodeSize } = this.options;
    if (log2)
  ...
  getClusters(bbox, zoom) {
    ...
    const clusters = [];
    for (const id of ids) {
      const c2 = tree.points[id];
      clusters.push(c2.numPoints ? getClusterJSON(c2) : this.points[c2.index]);
    }
    return clusters;
  }
  getChildren(clusterId) {
    ...
    const children = [];
    for (const id of ids) {
      const c2 = index.points[id];
      if (c2.parentId === clusterId) {
        children.push(c2.numPoints ? getClusterJSON(c2) : this.points[c2.index]);
      }
    }
  ...
  getTile(z, x2, y2) {
    ...
    this._addTileFeatures(tree.range((x2 - p) / z2, top, (x2 + 1 + p) / z2, bottom), tree.points, x2, y2, z2, tile);
    if (x2 === 0) {
  ...
  _addTileFeatures(ids, points, x2, y2, z2, tile) {
    for (const i of ids) {
      const c2 = points[i];
      const isCluster = c2.numPoints;
      let tags, px, py;
      if (isCluster) {
        tags = getClusterProperties(c2);
        px = c2.x;
        py = c2.y;
      } else {
        const p = this.points[c2.index];
        tags = p.properties;
      ...
      if (isCluster) {
        ...
        id = c2.index;
      } else if (this.points[c2.index].id) {
        id = this.points[c2.index].id;
      }
      if (id !== void 0)
        f.id = id;
  ...
  _map(point4, clone) {
    if (point4.numPoints) {
      return clone ? extend({}, point4.properties) : point4.properties;
    }
    const original = this.points[point4.index].properties;
    const result = this.options.map(original);
    return clone && result === original ? extend({}, result) : result;
  }
};
function createCluster(x2, y2, id, numPoints, properties) {
  return {
    x: fround(x2),
    y: fround(y2),
    zoom: Infinity,
...
function createPointCluster(p, id) {
  const [x2, y2] = p.geometry.coordinates;
  return {
    x: fround(lngX(x2)),
    y: fround(latY(y2)),
    zoom: Infinity,
...
var SuperClusterAlgorithm = class extends AbstractAlgorithm {
  ...
  cluster({ map: map3 }) {
    return this.superCluster.getClusters([-180, -90, 180, 90], Math.round(map3.getZoom())).map(this.transformCluster.bind(this));
  }
...
var ClusterStats = class {
  constructor(markers, clusters) {
    ...
    const clusterMarkerSum = clusterMarkerCounts.reduce((a2, b) => a2 + b, 0);
    this.clusters = {
...
var MarkerClusterer = class extends OverlayViewSafe {
  constructor({ map: map3, markers = [], algorithm = new SuperClusterAlgorithm({}), renderer = new DefaultRenderer(), onClusterClick = defaultOnClusterClickHandler }) {
    super();
    this.markers = [...markers];
    this.clusters = [];
  ...
  render() {
    ...
    if (map3 instanceof google.maps.Map && this.getProjection()) {
...
var DrawMap = ({ pins, onPinClick }) => {
  ...
  const [map3, setMap] = (0, import_react.useState)();
  ...
  new MarkerClusterer({ markers, map: map3 });
...
var ListItemSecondaryAction = /* @__PURE__ */ React4.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemSecondaryAction"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ListItemSecondaryActionRoot, _extends({
...
var ListItem = /* @__PURE__ */ React5.forwardRef(function ListItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItem"
  });
  const {
    ...
    secondaryAction,
    selected = false
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded4), other = _objectWithoutPropertiesLoose(props, _excluded23);
  ...
  let Component5 = componentProp || "li";
  if (button) {
  ...
  if (hasSecondaryAction) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(ListItemContainer, _extends({
        as: ContainerComponent,
        className: clsx_m_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState
      }, ContainerProps, {
        children: [/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Root, _extends({}, rootProps, !isHostComponent_default(Root) && {
          as: Component5,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListContext_default.Provider, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Root, _extends({}, rootProps, {
      ...
      children: [children, secondaryAction && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListItemSecondaryAction_default, {
...
var TableContext = /* @__PURE__ */ React6.createContext();
if (true) {
...
var _excluded5 = ["className", "component", "padding", "size", "stickyHeader"];
...
var Table = /* @__PURE__ */ React7.forwardRef(function Table2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTable"
  });
  ...
  const table = React7.useMemo(() => ({
    padding,
    size,
    stickyHeader
  }), [padding, size, stickyHeader]);
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TableContext_default.Provider, {
    value: table,
    children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TableRoot, _extends({
      as: component,
...
var Tablelvl2Context = /* @__PURE__ */ React8.createContext();
if (true) {
...
var TableBody = /* @__PURE__ */ React9.forwardRef(function TableBody2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableBody"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl2,
    children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(TableBodyRoot, _extends({
      className: clsx_m_default(classes.root, className),
      as: component,
      ref,
...
var _excluded7 = ["align", "className", "component", "padding", "scope", "size", "sortDirection", "variant"];
...
var TableCell = /* @__PURE__ */ React10.forwardRef(function TableCell2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableCell"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TableCellRoot, _extends({
    as: component,
    ref,
    className: clsx_m_default(classes.root, className),
    "aria-sort": ariaSort,
...
var TableContainer = /* @__PURE__ */ React11.forwardRef(function TableContainer2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableContainer"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TableContainerRoot, _extends({
    ref,
    as: component,
    className: clsx_m_default(classes.root, className),
    ownerState
...
var _excluded9 = ["className", "component", "hover", "selected"];
...
var TableRow = /* @__PURE__ */ React12.forwardRef(function TableRow2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTableRow"
  });
  ...
  const tablelvl22 = React12.useContext(Tablelvl2Context_default);
  const ownerState = _extends({}, props, {
    component,
    hover,
    selected,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(TableRowRoot, _extends({
    as: component,
    ref,
    className: clsx_m_default(classes.root, className),
...
function Surface(props) {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("svg", _extends2({}, filterProps(others, true, true), {
...
function Layer(props) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("g", _extends3({
    className: layerClass
...
// node_modules/recharts/node_modules/d3-shape/src/index.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/constant.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/math.js
init_react();
var pi2 = Math.PI;
var halfPi = pi2 / 2;
var tau2 = 2 * pi2;

// node_modules/recharts/node_modules/d3-shape/src/area.js
init_react();

// node_modules/recharts/node_modules/d3-shape/src/array.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/curve/linear.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/line.js
init_react();

// node_modules/recharts/node_modules/d3-shape/src/point.js
init_react();
function x(p) {
  return p[0];
}
...
// node_modules/recharts/node_modules/d3-shape/src/symbol.js
init_react();

// node_modules/recharts/node_modules/d3-shape/src/symbol/circle.js
init_react();
var circle_default = {
...
// node_modules/recharts/node_modules/d3-shape/src/symbol/cross.js
init_react();
var cross_default = {
  draw: function(context, size) {
...
// node_modules/recharts/node_modules/d3-shape/src/symbol/diamond.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/symbol/star.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/symbol/square.js
init_react();
var square_default = {
  draw: function(context, size) {
...
// node_modules/recharts/node_modules/d3-shape/src/symbol/triangle.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/symbol/wye.js
init_react();
var c = -0.5;
var s = Math.sqrt(3) / 2;
...
// node_modules/recharts/node_modules/d3-shape/src/curve/basisClosed.js
init_react();

// node_modules/recharts/node_modules/d3-shape/src/noop.js
init_react();
function noop_default() {
}

// node_modules/recharts/node_modules/d3-shape/src/curve/basis.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/curve/basisOpen.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/curve/linearClosed.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/curve/monotone.js
init_react();
function sign(x2) {
  return x2 < 0 ? -1 : 1;
}
...
// node_modules/recharts/node_modules/d3-shape/src/curve/natural.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/curve/step.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/stack.js
init_react();

// node_modules/recharts/node_modules/d3-shape/src/offset/none.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/order/none.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/offset/expand.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/offset/silhouette.js
init_react();
...
// node_modules/recharts/node_modules/d3-shape/src/offset/wiggle.js
init_react();
...
function _setPrototypeOf(o, p) {
  _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
  ...
  _createClass(Symbols2, [{
    ...
    value: function render() {
      ...
      if (cx === +cx && cy === +cy && size === +size) {
        return /* @__PURE__ */ import_react5.default.createElement("path", _extends4({}, filterProps(this.props, true), {
...
function _setPrototypeOf2(o, p) {
  _setPrototypeOf2 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
  ...
  _createClass2(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react6.default.createElement("li", _extends5({
          className,
          style: itemStyle,
...
function _setPrototypeOf3(o, p) {
  _setPrototypeOf3 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var import_fast_equals2 = __toESM(require_fast_equals2());
...
var configUpdate_default = function(from, to, easing, duration, render) {
  ...
  var timingUpdate = function timingUpdate2(now) {
    ...
    var currStyle = mapObject(function(key, val) {
      return alpha2.apply(void 0, _toConsumableArray2(val).concat([easing(t)]));
    }, timingStyle);
    ...
    if (t < 1) {
      ...
      var finalStyle = mapObject(function(key, val) {
        return alpha2.apply(void 0, _toConsumableArray2(val).concat([easing(1)]));
      }, timingStyle);
...
function _setPrototypeOf4(o, p) {
  _setPrototypeOf4 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var Animate = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass4(Animate2, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if ((0, import_fast_equals2.deepEqual)(prevProps.to, this.props.to) && prevProps.canBegin && prevProps.isActive) {
        return;
      }
    ...
    value: function render() {
      ...
      var count = import_react8.Children.count(children);
      ...
      var cloneContainer = function cloneContainer2(container) {
        ...
        var res = /* @__PURE__ */ (0, import_react8.cloneElement)(container, _objectSpread5(_objectSpread5({}, others), {}, {
      ...
      return /* @__PURE__ */ import_react8.default.createElement("div", null, import_react8.Children.map(children, function(child) {
...
Animate.propTypes = {
  from: import_prop_types10.default.oneOfType([import_prop_types10.default.object, import_prop_types10.default.string]),
  to: import_prop_types10.default.oneOfType([import_prop_types10.default.object, import_prop_types10.default.string]),
  attributeName: import_prop_types10.default.string,
  duration: import_prop_types10.default.number,
  begin: import_prop_types10.default.number,
  easing: import_prop_types10.default.oneOfType([import_prop_types10.default.string, import_prop_types10.default.func]),
  steps: import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
    duration: import_prop_types10.default.number.isRequired,
    style: import_prop_types10.default.object.isRequired,
    easing: import_prop_types10.default.oneOfType([import_prop_types10.default.oneOf(["ease", "ease-in", "ease-out", "ease-in-out", "linear"]), import_prop_types10.default.func]),
    properties: import_prop_types10.default.arrayOf("string"),
    onAnimationEnd: import_prop_types10.default.func
  })),
  children: import_prop_types10.default.oneOfType([import_prop_types10.default.node, import_prop_types10.default.func]),
  isActive: import_prop_types10.default.bool,
  canBegin: import_prop_types10.default.bool,
  onAnimationEnd: import_prop_types10.default.func,
  shouldReAnimate: import_prop_types10.default.bool,
  onAnimationStart: import_prop_types10.default.func,
  onAnimationReStart: import_prop_types10.default.func
};
...
function _setPrototypeOf5(o, p) {
  _setPrototypeOf5 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var AnimateGroupChild = /* @__PURE__ */ function(_Component) {
  ...
  _createClass5(AnimateGroupChild2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react9.default.createElement(import_react_transition_group2.Transition, _extends6({}, props, {
        onEnter: this.handleEnter,
        onExit: this.handleExit,
        timeout: this.parseTimeout()
      }), function() {
        return /* @__PURE__ */ import_react9.default.createElement(Animate_default, _this2.state, import_react9.Children.only(children));
      });
    }
  }]);
...
AnimateGroupChild.propTypes = {
  appearOptions: import_prop_types11.default.object,
  enterOptions: import_prop_types11.default.object,
  leaveOptions: import_prop_types11.default.object,
...
function AnimateGroup(props) {
  ...
  return /* @__PURE__ */ import_react10.default.createElement(import_react_transition_group3.TransitionGroup, {
    component
  }, import_react10.Children.map(children, function(child, index) {
    return /* @__PURE__ */ import_react10.default.createElement(AnimateGroupChild_default, {
...
AnimateGroup.propTypes = {
  appear: import_prop_types12.default.object,
  enter: import_prop_types12.default.object,
  leave: import_prop_types12.default.object,
  children: import_prop_types12.default.oneOfType([import_prop_types12.default.array, import_prop_types12.default.element]),
...
function _setPrototypeOf6(o, p) {
  _setPrototypeOf6 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var DefaultTooltipContent = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass6(DefaultTooltipContent2, [{
    ...
    value: function renderContent3() {
      ...
      if (payload && payload.length) {
        ...
        var items = (itemSorter ? (0, import_sortBy.default)(payload, itemSorter) : payload).map(function(entry, i) {
          ...
          }, isNumOrStr(name) ? /* @__PURE__ */ import_react11.default.createElement("span", {
            className: "recharts-tooltip-item-name"
          }, name) : null, isNumOrStr(name) ? /* @__PURE__ */ import_react11.default.createElement("span", {
            className: "recharts-tooltip-item-separator"
          }, separator) : null, /* @__PURE__ */ import_react11.default.createElement("span", {
            className: "recharts-tooltip-item-value"
          }, value), /* @__PURE__ */ import_react11.default.createElement("span", {
    ...
    value: function render() {
      ...
      }, /* @__PURE__ */ import_react11.default.isValidElement(finalLabel) ? finalLabel : "".concat(finalLabel)), this.renderContent());
    }
  }]);
...
function _setPrototypeOf7(o, p) {
  _setPrototypeOf7 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function _setPrototypeOf8(o, p) {
  _setPrototypeOf8 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var toArray = function toArray2(children) {
  ...
  var result = [];
  import_react14.Children.forEach(children, function(child) {
...
var isChildrenEqual = function isChildrenEqual2(nextChildren, prevChildren) {
  ...
  if (count !== import_react14.Children.count(prevChildren)) {
    return false;
  }
  if (count === 0) {
    return true;
...
var renderByOrder = function renderByOrder2(children, renderMap2) {
  var elements = [];
  var record = {};
  toArray(children).forEach(function(child, index) {
    if (isSvgElement(child)) {
      ...
      var _ref3 = renderMap2[displayName] || {}, handler = _ref3.handler, once = _ref3.once;
...
function ordinal() {
  var index = /* @__PURE__ */ new Map(), domain = [], range4 = [], unknown = implicit;
  function scale(d) {
...
function transformer() {
  ...
  scale.invert = function(y2) {
    return clamp(untransform((input || (input = piecewise2(range4, domain.map(transform), number_default2)))(y2)));
  };
  scale.domain = function(_) {
...
function radial() {
  ...
  scale.range = function(_) {
    return arguments.length ? (squared.range((range4 = Array.from(_, number)).map(square)), scale) : range4.slice();
  };
  scale.rangeRound = function(_) {
...
init_react();
function ticker(year3, month2, week, day3, hour2, minute2) {
  const tickIntervals = [
  ...
  function tickInterval(start, stop, count) {
    ...
    if (i === tickIntervals.length)
      return year3.every(tickStep(start / durationYear, stop / durationYear, count));
    if (i === 0)
...
var t02 = new Date();
var t12 = new Date();
function newInterval2(floori, offseti, count, field) {
  function interval(date2) {
    return floori(date2 = arguments.length === 0 ? new Date() : new Date(+date2)), date2;
  }
  interval.floor = function(date2) {
...
function calendar(ticks, tickInterval, year3, month2, week, day3, hour2, minute2, second2, format2) {
  var scale = continuous(), invert = scale.invert, domain = scale.domain;
  var formatMillisecond = format2(".%L"), formatSecond = format2(":%S"), formatMinute = format2("%I:%M"), formatHour = format2("%I %p"), formatDay = format2("%a %d"), formatWeek = format2("%b %d"), formatMonth = format2("%B"), formatYear2 = format2("%Y");
  function tickFormat2(date2) {
    return (second2(date2) < date2 ? formatMillisecond : minute2(date2) < date2 ? formatSecond : hour2(date2) < date2 ? formatMinute : day3(date2) < date2 ? formatHour : month2(date2) < date2 ? week(date2) < date2 ? formatDay : formatWeek : year3(date2) < date2 ? formatMonth : formatYear2)(date2);
  }
  scale.invert = function(y2) {
  ...
  scale.copy = function() {
    return copy(scale, calendar(ticks, tickInterval, year3, month2, week, day3, hour2, minute2, second2, format2));
  };
  return scale;
}
function time() {
...
function transformer3() {
  var x0 = 0, x1 = 0.5, x2 = 1, s2 = 1, t03, t13, t2, k10, k21, interpolator = identity5, transform, clamp = false, unknown;
  function scale(x3) {
  ...
  scale.domain = function(_) {
    return arguments.length ? ([x0, x1, x2] = _, t03 = transform(x0 = +x0), t13 = transform(x1 = +x1), t2 = transform(x2 = +x2), k10 = t03 === t13 ? 0 : 0.5 / (t13 - t03), k21 = t13 === t2 ? 0 : 0.5 / (t2 - t13), s2 = t13 < t03 ? -1 : 1, scale) : [x0, x1, x2];
  };
  scale.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale) : clamp;
  };
  ...
  return function(t) {
    transform = t, t03 = t(x0), t13 = t(x1), t2 = t(x2), k10 = t03 === t13 ? 0 : 0.5 / (t13 - t03), k21 = t13 === t2 ? 0 : 0.5 / (t2 - t13), s2 = t13 < t03 ? -1 : 1;
    return scale;
  };
}
function diverging() {
...
var getDomainOfErrorBars = function getDomainOfErrorBars2(data2, item, dataKey, axisType) {
...
var parseErrorBarsOfAxis = function parseErrorBarsOfAxis2(data2, items, dataKey, axisType) {
  var domains = items.map(function(item) {
    return getDomainOfErrorBars(data2, item, dataKey, axisType);
...
var getDomainOfItemsWithSameAxis = function getDomainOfItemsWithSameAxis2(data2, items, type, filterNil) {
  var domains = items.map(function(item) {
    var dataKey = item.props.dataKey;
    if (type === "number" && dataKey) {
      return getDomainOfErrorBars(data2, item, dataKey) || getDomainOfDataByKey(data2, dataKey, type, filterNil);
    }
...
function _setPrototypeOf9(o, p) {
  _setPrototypeOf9 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function _setPrototypeOf10(o, p) {
  _setPrototypeOf10 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var getX2 = function getX3(p) {
  return p.x;
};
var getY2 = function getY3(p) {
  return p.y;
};
  ...
  _createClass10(Curve2, [{
    ...
    value: function getPath() {
      ...
      if ((0, import_isArray6.default)(baseLine)) {
        ...
        if (layout === "vertical") {
          lineFunction = area_default().y(getY2).x1(getX2).x0(function(d) {
            return d.base.x;
          });
        } else {
          lineFunction = area_default().x(getX2).y1(getY2).y0(function(d) {
            return d.base.y;
          });
        }
      ...
      if (layout === "vertical" && isNumber(baseLine)) {
        lineFunction = area_default().y(getY2).x1(getX2).x0(baseLine);
      } else if (isNumber(baseLine)) {
        lineFunction = area_default().x(getX2).y1(getY2).y0(baseLine);
      } else {
        lineFunction = line_default().x(getX2).y(getY2);
      }
      lineFunction.defined(defined).curve(curveFactory);
...
function _setPrototypeOf11(o, p) {
  _setPrototypeOf11 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function _setPrototypeOf12(o, p) {
  _setPrototypeOf12 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function _setPrototypeOf13(o, p) {
  _setPrototypeOf13 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function _setPrototypeOf14(o, p) {
  _setPrototypeOf14 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var createScale = function createScale2(_ref) {
  ...
  var scale = point3().domain((0, import_range3.default)(0, len)).range([x2, x2 + width - travellerWidth]);
...
function _setPrototypeOf15(o, p) {
  _setPrototypeOf15 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function _setPrototypeOf16(o, p) {
  _setPrototypeOf16 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
function ErrorBar(props) {
  var offset = props.offset, layout = props.layout, width = props.width, dataKey = props.dataKey, data2 = props.data, dataPointFormatter = props.dataPointFormatter, xAxis = props.xAxis, yAxis = props.yAxis, others = _objectWithoutProperties11(props, ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"]);
...
function _setPrototypeOf17(o, p) {
  _setPrototypeOf17 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var Line = /* @__PURE__ */ function(_PureComponent) {
  ...
  var _super = _createSuper17(Line2);
  function Line2() {
    var _this;
    _classCallCheck18(this, Line2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
...
function _setPrototypeOf18(o, p) {
  _setPrototypeOf18 = Object.setPrototypeOf || function _setPrototypeOf19(o2, p2) {
    o2.__proto__ = p2;
    return o2;
  };
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  return _temp = _class = /* @__PURE__ */ function(_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.handleReceiveSyncEvent = function(cId, chartId, data2) {
        ...
        if (syncId === cId && chartId !== _this.uniqueChartId) {
          _this.clearDeferId();
          _this.deferId = defer && defer(_this.applySyncEvent.bind(_assertThisInitialized18(_this), data2));
        }
      };
      ...
      _this.renderCustomized = function(element, displayName, index) {
        return /* @__PURE__ */ (0, import_react30.cloneElement)(element, _objectSpread25(_objectSpread25({
    ...
    _createClass19(CategoricalChartWrapper, [{
      ...
      value: function applySyncEvent(data2) {
        ...
        if (!(0, import_isNil10.default)(data2.dataStartIndex) || !(0, import_isNil10.default)(data2.dataEndIndex)) {
          ...
          this.setState(_objectSpread25(_objectSpread25({}, data2), {}, {
            activeLabel,
            activeCoordinate,
            activePayload,
            activeTooltipIndex
    ...
    if (data2 !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || layout !== prevState.prevLayout || stackOffset !== prevState.prevStackOffset || !shallowEqual(margin, prevState.prevMargin)) {
      ...
      var updatesToState = _objectSpread25(_objectSpread25({}, getTooltipData(prevState, data2, layout)), {}, {
...
var InfoDrawer = ({ title, id }) => {
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Typography_default, {
    variant: "h6",
    noWrap: true
  }, "Location Profile"), /* @__PURE__ */ React.createElement(TableContainer_default, null, /* @__PURE__ */ React.createElement(Table_default, {
    sx: { minWidth: 350 },
    "aria-label": "simple table"
  }, /* @__PURE__ */ React.createElement(TableBody_default, null, /* @__PURE__ */ React.createElement(TableRow_default, null, /* @__PURE__ */ React.createElement(TableCell_default, null, "ID"), /* @__PURE__ */ React.createElement(TableCell_default, {
    align: "right"
  }, "icr05623")), /* @__PURE__ */ React.createElement(TableRow_default, null, /* @__PURE__ */ React.createElement(TableCell_default, null, "Soil texture"), /* @__PURE__ */ React.createElement(TableCell_default, {
    align: "right"
  }, "NA")), /* @__PURE__ */ React.createElement(TableRow_default, null, /* @__PURE__ */ React.createElement(TableCell_default, null, "Upper depth (cm)"), /* @__PURE__ */ React.createElement(TableCell_default, {
    align: "right"
  }, "0")), /* @__PURE__ */ React.createElement(TableRow_default, null, /* @__PURE__ */ React.createElement(TableCell_default, null, "Lower depth (cm)"), /* @__PURE__ */ React.createElement(TableCell_default, {
    align: "right"
  }, "20")), /* @__PURE__ */ React.createElement(TableRow_default, null, /* @__PURE__ */ React.createElement(TableCell_default, null, "Address"), /* @__PURE__ */ React.createElement(TableCell_default, {
    align: "right"
  }, "NA"))))), /* @__PURE__ */ React.createElement(Typography_default, {
    variant: "h6",
    noWrap: true
  }, "VISNIR Spectra Profile"), /* @__PURE__ */ React.createElement(List_default, null, /* @__PURE__ */ React.createElement(ListItem_default, null, /* @__PURE__ */ React.createElement(ListItemText_default, {
    primary: "item"
  }))), /* @__PURE__ */ React.createElement(LineGraph, null), /* @__PURE__ */ React.createElement(Button_default, {
    variant: "contained",
    color: "primary"
...
// app/routes/index.tsx
function Index() {
  const [openDrawer, setOpenDrawer] = (0, import_react31.useState)(false);
  const pins = [
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Header, null), /* @__PURE__ */ React.createElement(Drawer_default, {
    anchor: "left",
    open: openDrawer,
 ...
 */
//# sourceMappingURL=/build/routes/index-RDDLV7QZ.js.map
