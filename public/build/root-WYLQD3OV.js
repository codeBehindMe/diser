...
var MyMapComponent = () => {
  ...
  (0, import_react2.useEffect)(() => {
    if (ref.current && !map) {
      setMap(new window.google.maps.Map(ref.current, { zoom: 8 }));
    }
  }, [ref, map]);
  return /* @__PURE__ */ React.createElement("div", {
    ref,
    id: "map",
    style: { width: 800, height: 600, background: "yellow", overflow: "visible" }
  });
};
function App() {
...
//# sourceMappingURL=/build/root-WYLQD3OV.js.map
